...
from .SugarUtils import addActiveKeymapItem as add
from .SugarUtils import disableActiveKeymapItem as disable
...
class BuildSugarKeyconfigOperator(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        bpy.app.timers.register(
            functools.partial(saveAndExportKeyconfig, 'Sugar_Keyconfig.py'), first_interval=0.2)  # must run async to properly cache changes after editOtherAddonsHotkeys and clearAllInactiveKeymapItemsInKeyconfig \
    ...
    def addInterfaceHotkeys(cls):
        ...
        for k, v in {
            ...
            add('Window', 'screen.space_type_set_or_cycle',
                k + ' shift ctrl', setKmiProps=lambda kmi: setSpaceTypeProp(kmi, v))
    ...
    def addViewHotkeys(cls):
        ...
        for kmn in ['Object Mode', 'Mesh', 'Sculpt', 'Vertex Paint', 'Weight Paint', 'Image Paint']:
            ...
            for k, v in {
                ...
                add(kmn, 'view3d.view_roll',
                    k + ' SPACE', setKmiProps=lambda kmi: setTypeProp(kmi, v), head=True)
                add(kmn, {'view3d.view_roll': {'angle': -1.309 if v == 'LEFT' else 1.309}},
    ...
    def addObjectHotkeys(cls):
        ...
        for kmn in ['Object Non-modal', 'Object Mode', 'Mesh', 'Sculpt', 'Vertex Paint', 'Weight Paint', 'Image Paint']:
            add(kmn, 'object.mode_set',
                'LEFT_ALT TAB', setKmiProps=lambda kmi: setModeProp(kmi, 'SCULPT'))
            add(kmn, 'object.mode_set',
        ...
        for kmn, v in {
            ...
            'Particle': 'particle.eveal',
            'UV Editor': 'uv.eveal',
            'Graph Editor Generic': 'graph.eveal',
            'Object Mode': {'object.hide_view_clear': {'select': True}},
        }.items():
            add(kmn, v,
                'H DOUBLE_CLICK', disableOld='H alt')
        for v in [
            {'object.hide_view_clear': {'select': True}},
            'outliner.collection_show'
        ]:
            add('Outliner', v,
                'H DOUBLE_CLICK')
        ...
        for kmn, v in {
            ...
            'Vertex Paint': {'mesh.reveal': {'select': False}},
            'Weight Paint': {'mesh.reveal': {'select': False}},
            'Image Paint': {'mesh.reveal': {'select': False}},
        ...
        add('Object Mode', 'object.empty_add',
            'ACCENT_GRAVE shift repeat', setKmiProps=lambda kmi: setTypeProp(kmi, 'PLAIN_AXES'))
        add('Object Mode', {'wm.call_menu': {'name': 'VIEW3D_MT_mesh_add'}},
            'ONE shift repeat')
        add('Object Mode', 'mesh.primitive_plane_add',
            'TWO shift repeat')
        ...
        add('Object Mode', 'object.add',
            'SIX shift repeat', setKmiProps=lambda kmi: setTypeProp(kmi, 'LATTICE'))
        add('Object Mode', 'object.add',
            'SEVEN shift repeat', setKmiProps=lambda kmi: setTypeProp(kmi, 'FONT'))

        add('Object Mode', 'object.convert',
            'C shift ctrl')
        add('Object Mode', 'object.convert',
            'B shift ctrl', setKmiProps=lambda kmi: setTargetProp(kmi, 'CURVE'))
        add('Object Mode', 'object.convert',
        ...
        add('Object Mode', {'object.select_linked': {'extend': True}},
            'S shift', setKmiProps=lambda kmi: setTypeProp(kmi, 'MATERIAL'))
        add('Object Mode', {'object.select_linked': {'extend': True}},
            'D shift', setKmiProps=lambda kmi: setTypeProp(kmi, 'OBDATA'))
        # link
        add('Object Mode', {'wm.call_menu': {'name': 'VIEW3D_MT_make_links'}},
            'E ctrl')
        add('Object Mode', 'object.make_links_data',
            'Q shift', setKmiProps=lambda kmi: setTypeProp(kmi, 'MATERIAL'))
        add('Object Mode', 'object.make_links_data',
            'LEFT_SHIFT ctrl DOUBLE_CLICK', setKmiProps=lambda kmi: setTypeProp(kmi, 'OBDATA'))
        for kmn in ['Object Mode', 'Outliner']:
        ...
        for kmn in ['Object Mode', 'Outliner']:
            ...
            add(kmn, {'object.parent_set': {'keep_transform': True}},
                'W ctrl', setKmiProps=lambda kmi: setTypeProp(kmi, 'OBJECT'))
            add(kmn, 'object.parent_clear',
                'P ctrl alt', setKmiProps=lambda kmi: setTypeProp(kmi, 'CLEAR_KEEP_TRANSFORM'))
            add(kmn, 'object.parent_clear',
                'W alt', setKmiProps=lambda kmi: setTypeProp(kmi, 'CLEAR_KEEP_TRANSFORM'))
        ...
        for kmn in ['Object Mode', 'Outliner']:
            ...
            add(kmn, {'object.select_grouped': {'extend': True}},
                'W shift', setKmiProps=lambda kmi: setTypeProp(kmi, 'PARENT'))
            add(kmn, {'object.select_grouped': {'extend': True}},
                'W shift RELEASE', setKmiProps=lambda kmi: setTypeProp(kmi, 'CHILDREN_RECURSIVE'))
    ...
    def addTransformationsHotkeys(cls):
        ...
        add('Object Mode', {'object.align': {'align_axis': 2}},
            'A ctrl alt CLICK')
        ...
        add('Object Mode', 'object.align',
            'LEFTMOUSE ctrl alt A', head=True)
        add('Object Mode', {'object.align': {'align_mode': 1}},
            'LEFTMOUSE ctrl alt A DOUBLE_CLICK', head=True)
        add('Object Mode', {'object.align': {'align_mode': 1}},
        ...
        for kmn, v in {
            ...
            add(kmn, {'wm.context_toggle': {'data_path': v}}, 'LEFT_SHIFT X')
    ...
    def addPropertiesHotkeys(cls):
        ...
        for i, n in enumerate(INDEXES):
            if i < 6:
                add('Object Mode', {'object.subdivision_set': {'level': i, 'relative': False}},
                    (n if i else 'ACCENT_GRAVE') + ' shift alt DOUBLE_CLICK', disableOld=n + ' ctrl')  # subdiv (cycle lvl)
    ...
    def addEditMeshHotkeys(cls):
        ...
        add('Mesh', {'mesh.fill_holes': {'sides': 0}}, 'A shift ctrl')
        ...
        add('Mesh', 'mesh.intersect', 'FOUR repeat')
        ...
        add('Mesh', 'mesh.knife_project', 'LEFT_CTRL C')
        ...
        add('Mesh', {'wm.tool_set_by_id': {'name': 'builtin.knife'}},
            'ONE alt repeat')
        add('Mesh', 'mesh.knife_tool',
            'LEFTMOUSE C', disableOldExactProps='K')
        ...
        add('Mesh', 'uv.cube_project', 'C shift ctrl')
        ...
        # vertex groups
        add('Mesh', {'wm.call_menu': {'name': 'VIEW3D_MT_vertex_group'}},
            'G shift', disableOldExactProps='G ctrl')
    ...
    def addCurvesHotkeys(cls):
        ...
        # curve
        add('Curve', 'curve.spline_type_set', 'C shift ctrl')
        ...
        for kmn, v in {
            ...
            add(kmn, v, 'C shift', disableOld='C alt')
        ...
        add('Curve', 'curve.handle_type_set',
            'ONE', setKmiProps=lambda kmi: setTypeProp(kmi, 'VECTOR'))
        add('Curve', 'curve.handle_type_set',
            'TWO', setKmiProps=lambda kmi: setTypeProp(kmi, 'AUTOMATIC'))
        add('Curve', 'curve.handle_type_set',
            'THREE', setKmiProps=lambda kmi: setTypeProp(kmi, 'FREE_ALIGN'))
        add('Curve', 'curve.handle_type_set',
            'FOUR', setKmiProps=lambda kmi: setTypeProp(kmi, 'ALIGNED'))
        add('Curve', 'curve.handle_type_set',
        ...
        add('3D View Tool: Edit Curve, Curve Pen', {'curve.pen': {'delete_point': True}},
            'LEFTMOUSE alt')
        add('3D View Tool: Edit Curve, Curve Pen', 'transform.resize',
            'RIGHTMOUSE shift CLICK_DRAG')
        add('3D View Tool: Edit Curve, Curve Pen', 'transform.rotate',
    ...
    def addSculptHotkeys(cls):
        ...
        add('Sculpt', {'wm.context_set_float': {'data_path': 'scene.tool_settings.sculpt.automasking_view_normal_falloff'}},
            'F ctrl alt RELEASE', setKmiProps=lambda kmi: setValueProp(kmi, 0.0))
        add('Sculpt', {'wm.context_toggle': {'data_path': 'scene.tool_settings.sculpt.brush.use_automasking_view_normal'}},
            'F ctrl alt')
        ...
        # paint curve
        add('Paint Curve', 'wm.blend_strings_utf8_validate',
            'RIGHTMOUSE ctrl alt')  # dummy
        ...
        add('Paint Curve', {'paintcurve.slide': {'align': True, 'select': True}},
            'LEFTMOUSE DOUBLE_CLICK', disableOld='RIGHTMOUSE shift')
        add('Paint Curve', 'transform.translate',
            'RIGHTMOUSE CLICK_DRAG', disableOld='LEFTMOUSE CLICK_DRAG')
        disable('Paint Curve', 'transform.translate', 'G')
        add('Paint Curve', 'transform.resize',
            'RIGHTMOUSE shift', disableOld='S')
        add('Paint Curve', 'transform.rotate',
            'RIGHTMOUSE alt', disableOld='R', setKmiProps=lambda kmi: setOrientTypeProp(kmi, 'VIEW'))
        ...
        add('Sculpt', 'sculpt.sample_detail_size',
            'D shift alt', setKmiProps=lambda kmi: setModeProp(kmi, 'DYNTOPO'))
        ...
        add('Sculpt', 'sculpt.sample_detail_size',
            'R shift alt', setKmiProps=lambda kmi: setModeProp(kmi, 'VOXEL'))
        ...
        add('Sculpt', 'mesh.paint_mask_extract',
            'D shift ctrl')
        ...
        add('Sculpt', 'mesh.face_set_extract',
            'V shift ctrl')
        ...
        add('Sculpt', 'object.modifier_add',
            'ONE shift alt DOUBLE_CLICK', setKmiProps=lambda kmi: setTypeProp(kmi, 'SUBSURF'))  # subdiv
        for i, n in enumerate(INDEXES):
            if i < 6:
        ...
        add('Sculpt', 'paint.brush_select',
            'FIVE', setKmiProps=lambda kmi: setSculptToolProp(kmi, 'MULTIPLANE_SCRAPE'))
    ...
    def addPaintHotkeys(cls):
        ...
        for kmn in ['Vertex Paint', 'Image Paint', 'Sculpt']:
            ...
            add(kmn, 'brush.stencil_control',
                'RIGHTMOUSE shift CLICK_DRAG', disableOld='RIGHTMOUSE shift', setKmiProps=lambda kmi: setModeProp(kmi, 'SCALE'))
            add(kmn, 'brush.stencil_control',
                'RIGHTMOUSE alt CLICK_DRAG', disableOld='RIGHTMOUSE ctrl', setKmiProps=lambda kmi: setModeProp(kmi, 'ROTATION'))
            add(kmn, 'brush.stencil_reset_transform',
    ...
    def addImageAndUvHotkeys(cls):
        ...
        add('UV Editor', 'uv.average_islands_scale',
            'A shift ctrl')
        add('UV Editor', {'uv.pack_islands': {'rotate': True, 'margin': 0.01, 'pin': True}},
        ...
        add('UV Editor', 'uv.stitch',
            'D alt', disableOld='V alt')
        add('UV Editor', {'wm.call_menu': {'name': 'IMAGE_MT_uvs_align'}},
            'A ctrl alt', disableOld='W shift')
    ...
    def addFileBrowserHotkeys(cls):
        ...
        add('File Browser', 'file.previous',
            'RIGHT_BRACKET', disableOld='BACK_SPACE')
        add('File Browser', 'file.next',
            'LEFT_BRACKET', disableOld='BACK_SPACE shift')
    ...
    def editOtherAddonsHotkeys(cls):
        ...
        if 'space_view3d_copy_attributes' in bpy.context.preferences.addons:
            ...
            addUserKeymapItem('Object Mode', 'object.copy_obj_vis_rot',
                              'D shift ctrl DOUBLE_CLICK')
            addUserKeymapItem('Object Mode', 'object.copy_obj_mod',
                              'A shift alt')
...
def setRotationMethodProp(kmi, *args): kmi.properties.rotation_method = args[0]
...
def setAxisProp(kmi, *args):
    kmi.properties.MESH_OT_select_mirror.axis = {args[0]}
...
def setContextToggleValuesProp(kmi, v1, v2):
